...
module.exports = {
  theme: {
    extend: {
      colors: {
        // Couleurs primaires de la marque Nestor Design
        nestor: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
        ...
        // Couleurs neutres avec plus de nuances
        neutral: {
          25: '#fcfcfd',
          50: '#f9fafb',
          100: '#f3f4f6',
      ...
      spacing: {
        // Espacements supplémentaires pour plus de flexibilité
        '18': '4.5rem',
        '88': '22rem',
        '128': '32rem',
      },
  ...
  plugins: [
    // Plugin pour les utilitaires de glassmorphism
